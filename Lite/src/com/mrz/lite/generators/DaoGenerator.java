...
public class DaoGenerator implements Generator {
	...
	public void generate(JavaFileObject jfo, EntityModel entityModel) {
		try {
			...
			bw.newLine();
			bw.append("                                } else fks_left.add(Long.parseLong(idFieldToGet.get(field.get(obj)).toString()));");
			bw.newLine();
			bw.append("                                idFieldToGet.setAccessible(false);");
			bw.newLine();
			bw.append("                            }");
			...
			bw.newLine();
			bw.newLine();
			bw.append("    private void switchBackTo(String method) {");
			bw.newLine();
			bw.append("        if(\"select\".equals(method)) {");
			bw.newLine();
			bw.append("            db = liteCore.getReadableDatabase();");
			bw.newLine();
			bw.append("        } else {");
			...
			bw.append("        }");
			bw.newLine();
			bw.append("        entityClazz = oldClazz;");
			bw.newLine();
			bw.append("    }");
			bw.newLine();
			bw.append("}");
